	...
	public function process() {
		...
		$attributeMatchingTableHtml = '
			...
			<tbody id="tbodyDynamicMatchingHeadline" style="display:none;">
				<tr class="headline">
					<td colspan="1"><h4>' . str_replace('%marketplace%', ucfirst($this->marketplace), ML_GENERAL_VARMATCH_MP_ATTRIBUTE) . '</h4></td>
		...
		<script type="text/javascript" src="<?php echo DIR_MAGNALISTER_WS ?>js/marketplaces/hitmeister/variation_matching.js"></script>
