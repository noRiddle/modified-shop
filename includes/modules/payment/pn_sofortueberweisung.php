...
class pn_sofortueberweisung {
	...
	function install () {
		...
		if (isset($_GET['autoinstall']) && ($_GET['autoinstall'] == '1')) {
			...
			xtc_db_query("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_key, configuration_value,  configuration_group_id, sort_order, date_added) values ('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_REASON_2', '" . xtc_db_input(STORE_NAME) . "', '6', '4', now())");
