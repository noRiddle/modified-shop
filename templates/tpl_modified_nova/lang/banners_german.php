...
/* -----------------------------------------------------------------------------------------
  ...
  define('TEXT_SLIDER_BANNER', 'Slider / Banner');
  define('TEXT_BANNER_GROUP', 'Banner-Gruppe:');
  define('TEXT_WIDTH', 'Breite');
  define('TEXT_DESKTOP', 'Desktop:');
  define('TEXT_MOBILE', 'Mobil:');
  define('TEXT_BANNER_ROW_1', 'Banner Reihe 1');  
  define('TEXT_BANNER_ROW_2', 'Banner Reihe 2');  
  define('TEXT_BANNER_ROW_3', 'Banner Reihe 3');
  define('TEXT_BANNER_ROW_4', 'Banner Reihe 4');    
