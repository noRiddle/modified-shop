<?php
/* -----------------------------------------------------------------------------------------
   $Id: add_a_quickie.php 75 2012-12-02 10:00:53Z Markus $
...
$box_smarty->assign('INPUT_FIELD',xtc_draw_input_field('quickie','',' class="boxfield_kurz"'));
$box_smarty->assign('SUBMIT_BUTTON', xtc_image_submit('button_add_quick.gif', BOX_HEADING_ADD_PRODUCT_ID,'class="box_button"'));
