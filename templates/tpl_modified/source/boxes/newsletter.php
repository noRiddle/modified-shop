<?php
  /* -----------------------------------------------------------------------------------------
   $Id: newsletter.php 2 2012-11-21 15:30:32Z GTB $
  ...
  if (!$box_smarty->is_cached(CURRENT_TEMPLATE.'/boxes/box_newsletter.html', $cache_id) || !$cache) {
    ...
    $box_smarty->assign('FIELD_EMAIL',xtc_draw_input_field('email', '', 'maxlength="50" class="boxfield_newsletter"'));
    $box_smarty->assign('BUTTON',xtc_image_submit('button_login_newsletter.gif', IMAGE_BUTTON_LOGIN,'class="box_footer_button"'));
