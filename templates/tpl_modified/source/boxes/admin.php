<?php
  ...
  if ($product->isProduct()) {
    ...
    $box_smarty->assign('EDIT_PRODUCT', xtc_href_link_admin((defined('DIR_WS_ADMIN') ? DIR_WS_ADMIN : 'admin/').'categories.php', 'cPath='.$cPath.'&pID='.$product->data['products_id'].'&action=new_product'));
    $box_smarty->assign('EDIT_PRODUCT_ATTRIBUTES', xtc_href_link_admin((defined('DIR_WS_ADMIN') ? DIR_WS_ADMIN : 'admin/').'new_attributes.php', 'cpath='.$cPath.'&current_product_id='.$product->data['products_id'].'&action=edit'));
    ...
    $box_smarty->assign('EDIT_CONTENT', xtc_href_link_admin((defined('DIR_WS_ADMIN') ? DIR_WS_ADMIN : 'admin/').'content_manager.php', 'action=edit&coID='.$content_data['content_id']));
    ...
    $box_smarty->assign('EDIT_CATEGORY', xtc_href_link_admin((defined('DIR_WS_ADMIN') ? DIR_WS_ADMIN : 'admin/').'categories.php', 'action=edit_category&cPath='.$cpath.'&cID='.$cid));
  }
...
*/
  ...
  $box_smarty->assign('ORDERS', xtc_href_link_admin('admin/orders.php','', 'NONSSL'));
