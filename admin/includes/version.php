...
define('DB_VERSION', 'MOD_3.2.0'); // ToDo before release!

define('PROJECT_MAJOR_VERSION', '3');
define('PROJECT_MINOR_VERSION', '2.0');
define('PROJECT_REVISION', '16725'); // ToDo before release!
define('PROJECT_SERVICEPACK_VERSION', ''); // currently not in use since new version numbers
define('PROJECT_RELEASE_DATE', '2025-12-18'); // ToDo before release!
