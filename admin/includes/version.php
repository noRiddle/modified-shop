...
define('DB_VERSION', 'MOD_2.0.3.0'); // ToDo before release!

define('PROJECT_MAJOR_VERSION', '2');
define('PROJECT_MINOR_VERSION', '0.3.0');
define('PROJECT_REVISION', '10907'); // ToDo before release!
define('PROJECT_SERVICEPACK_VERSION', ''); // currently not in use since new version numbers
define('PROJECT_RELEASE_DATE', '2017-08-16'); // ToDo before release!
