<?php
  ...
  $accepted_image_extensions = array("jpg","jpeg","jpe","gif","png","tiff","tif","bmp","svg");
  $accepted_image_mime_types = array("image/jpeg","image/gif","image/png","image/bmp","image/svg","image/svg+xml");
