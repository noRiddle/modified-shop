...
<!-- FÜR BANNER-ÜBERSICHT EINGEFÜGT -->
<table width="100%" border="0" cellpadding="0" cellspacing="3" style="text-align:center; font-family:Verdana, Geneva, sans-serif; font-size:11px;">
  <tr>
    <td height="50" colspan="3" style="background-color:#cc0000;color:#fff;"><p><strong>BANNER-EINSTELLUNGEN</strong><br />
      5 Banner-M&ouml;glichkeiten vorinstalliert, jeweils beim Banner den Banner-Platzhalter Namen angeben.
    </p></td>
  </tr>
  <tr>
    <td width="20%" rowspan="2" style="background-color:#CCC;">Menu</td>
    <td height="50" colspan="2" style="background-color:#0C3;">Banner<br />645 x 237 px</td>
  </tr>
  <tr>
    <td width="40%" height="50" style="background-color:#CF6;">Banner2<br />322 x 237 px</td>
    <td width="40%" height="50" style="background-color:#FC9;">Banner3<br />322 x 237 px</td>
  </tr>
  <tr>
    <td width="20%" height="50" style="background-color:#39F;">Banner5<br />230 x 160 px (oder h&ouml;her)</td>
    <td height="50" colspan="2" style="background-color:#6CC;">Banner4<br />645 x 237 px</td>
  </tr>
  <tr>
    <td width="20%" height="50" style="background-color:#FFF;"><br /></td>
    <td height="50" colspan="2" style="background-color:#ff6633;">Banner6 (Banner-Animation)<br />645 x 237 px</td>
  </tr>
</table>
<!-- FÜR BANNER-ÜBERSICHT EINGEFÜGT - ENDE -->
</td>
      </tr>
<?php
  if ($_GET['action'] == 'new') {
