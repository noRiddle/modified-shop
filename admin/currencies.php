            ...
            <td class="boxCenterLeft">
              <table class="tableBoxCenter collapse">
                ...
                ?>
                  ...
                  <td class="dataTableContent txta-r"><?php echo number_format($currency['value'], 4); ?></td>
              ...
              <div class="smallText pdg2 flt-l"><?php echo $currency_split->display_count($currency_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, $curr_page, TEXT_DISPLAY_NUMBER_OF_CURRENCIES); ?></div>
              <div class="smallText pdg2 flt-r"><?php echo $currency_split->display_links($currency_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $curr_page); ?></div>

              <?php
              if (empty($action)) {
              ?>
              <div class="clear"></div>
              <div class="pdg2 flt-l"><?php if (CURRENCY_SERVER_PRIMARY) { echo '<a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CURRENCIES, 'page=' . $curr_page . '&cID=' . $cInfo->currencies_id . '&action=update') . '">' . BUTTON_CURRENCY_UPDATE . '</a>'; } ?></div>
              <div class="pdg2 flt-r"><?php echo '<a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CURRENCIES, 'page=' . $curr_page . '&cID=' . $cInfo->currencies_id . '&action=new') . '">' . BUTTON_NEW_CURRENCY . '</a>'; ?></div>
