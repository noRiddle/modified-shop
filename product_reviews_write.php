...
if ($product->isProduct() === false) {
  ...
  $smarty->assign('INPUT_RATING_CSS', '<label>'.xtc_draw_radio_field('rating', '5', (($rating == '5') ? true : false)).'</label><label>'.xtc_draw_radio_field('rating', '4', (($rating == '4') ? true : false)).'</label><label>'.xtc_draw_radio_field('rating', '3', (($rating == '3') ? true : false)).'</label><label>'.xtc_draw_radio_field('rating', '2', (($rating == '2') ? true : false)).'</label><label>'.xtc_draw_radio_field('rating', '1', (($rating == '1') ? true : false)).'</label>');
