...
$smarty->assign('FORM_ACTION', xtc_draw_form('checkout_address', xtc_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, $params.'action=new', 'SSL'), 'post', 'onsubmit="return check_form_optional(checkout_address);"').secure_form('checkout_address'));
