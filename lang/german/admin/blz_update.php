...
define('BLZ_LINK_INVALID_TEXT', '<span class="messageStackError">Ung&uuml;ltiger Weblink zur BLZ-Datei. Nur TXT-Dateien von der Homepage der Bundesbank (www.bundesbank.de) sind zul&auml;ssig!</span><br /><br />');
