...
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_REFUNDED_GERMAN_TITLE','event-conflict!');
...
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_REFUNDED_ENGLISH_TITLE','event-conflict!');
