...
$lang_array = array(
  ...
  'MODULE_PAYMENT_PAYPALLINK_TEXT_EXTENDED_DESCRIPTION' => '<strong><font color="red">ACHTUNG:</font></strong> Bitte nehmen Sie noch die Einstellungen unter Partner Module -> PayPal -> Module -> <a href="'.xtc_href_link('paypal_module.php').'"><strong>PayPal</strong></a> vor!',
