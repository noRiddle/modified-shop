<?php
define('MODULE_ORDER_TOTAL_BILLPAY_FEE_TITLE', 'Suppl&eacute;ment mode de paiement Facture (Billpay)');
define('MODULE_ORDER_TOTAL_BILLPAY_FEE_DESCRIPTION', 'Calcul du suppl&eacute;ment pour les commandes avec le mode de paiement Facture (Billpay)');

define('MODULE_ORDER_TOTAL_BILLPAY_FEE_STATUS_TITLE', 'Suppl&eacute;ment mode de paiement Paiement sur facture ');
define('MODULE_ORDER_TOTAL_BILLPAY_FEE_STATUS_DESC', 'Calcul du suppl&eacute;ment de facturation');
