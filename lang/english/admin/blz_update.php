...
define('BLZ_LINK_INVALID_TEXT', '<span class="messageStackError">Invalid weblink to the bank code number file. Only TXT-files from the webpage of the German Bundesbank (www.bundesbank.de) are allowed!</span><br /><br />');
