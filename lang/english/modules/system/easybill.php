...
define('MODULE_EASYBILL_API_DESC','Key has to be created in easyBill provider menu.');
define('MODULE_EASYBILL_BILLINGID_TITLE','Manage Invoicenumber:');
define('MODULE_EASYBILL_BILLINGID_DESC','The settings for easyBill have to be made in the provider menu of easyBill.<br/><br/>If the invoice numbers are managed by the shop, then unique sequential invoice numbers have to be ensured.');
...
define('MODULE_EASYBILL_NO_AUTO_PAYMENT_DESC','Which payment methods are not automatically set to paid? List separated by a semicolon (;)');
define('MODULE_EASYBILL_STATUS_CHANGE_TITLE','Order status');
define('MODULE_EASYBILL_STATUS_CHANGE_DESC','Set to this status after invoicing.');
define('MODULE_EASYBILL_STANDARD_TAX_CLASS_TITLE','<hr /><b>Tax class:</b>');
define('MODULE_EASYBILL_STANDARD_TAX_CLASS_DESC','Please provide a standard tax class, if no tax class can be determined.');
