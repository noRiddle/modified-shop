...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_MATOMO_LOCAL_PATH_TITLE' , 'Matomo install path (without "http://")');
  define('MODULE_MATOMO_LOCAL_PATH_DESC' , 'Enter the path when Matomo was installed successfully. The complete path of the domain has to be given, but without "http://", e.g. "www.example.com/matomo".');

  define('MODULE_MATOMO_GOAL_TITLE' , 'Matomo campaign number (optional)');
  define('MODULE_MATOMO_GOAL_DESC' , 'Enter your campaign number, if you want to track predefined goals. Details see <a href="https://matomo.org/docs/tracking-goals-web-analytics/" target="_blank"><b>Matomo: Tracking Goal Conversions</b></a>');

  define('MODULE_MATOMO_COUNT_ADMIN_TITLE' , 'Count page views of the shop owner');
  define('MODULE_MATOMO_COUNT_ADMIN_DESC' , 'By activating this option, all page views of the administration usersof the shop owner will be counted as well. This will falsify the visitor stats.');
